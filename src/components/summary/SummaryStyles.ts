...
grid-template-columns: repeat(3, 1fr); //porque tem 3 colunas dentro do grid , todas com mesmo tamanho
...
${props => props.variant === 'green' && css` // se a variant for  igual green, aplica o estilo
