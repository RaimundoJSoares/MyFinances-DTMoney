...
background: rgba(0, 0, 0, 0.75); // 75% de opacidade para o fundo, ou seja, fundo mais escuro
...
export const Content = styled(Dialog.Content)`
    ...
    top: 50%; //um hack
    left: 50%; //um hack
    transform: translate(-50%, -50%); // centraliza o conteudo no centro da tela, um hack
